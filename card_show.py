...
class card_show(QWidget, Ui_Form):
    ...
    def default_size1(self):
        ...
        self.target_card.setGeometry(int(screen1.width() / 2 - 150), int(screen1.height() / 2 - 200), 300, 400)
        self.pushButton.setGeometry(int(screen1.width() / 2 - 100), int(screen1.height() / 2 + 200), 200, 100)
